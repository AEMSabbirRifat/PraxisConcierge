...
---
> **A new workflow for our partner marketing team**
>
> **Background:** We receive leads from external sources (affiliate websites, partners). Right now, they are sent via email and need to be manually imported into our CRM which is timeconsuming and error prone.
>
> **Task:** Craft a workflow that partner leads can be automatically imported into our CRM solution. Which tools are required to achieve this integration?
...
---
> **Evaluation/ priorization of integration partners**
>
> **Background:** As a provider of phone assistance for healthcare providers, PraxisConcierge integrates with 50+ practice software vendors in Germany. Every quarter, the KBV (Kassenärztliche Bundesvereinigung) published the # installations per system.
>
> **Task:** Evaluate the top20 systems on the German market that we should focus on for strategic partnerships
...
>
> **Source:** https://update.kbv.de/ita-update/Service-Informationen/Installationsstatistiken/Gesamt_Systeme_Installationen.pdf
>
...
>
> **Task 3.1:** Benchmark our website: https://praxisconcierge.de/ against this direct competitor: https://mediform.io/
> 
> **Task 3.2:** What are the top 3 growth tactics/ actions that we should steal from them immediately?
...
### 3.1 Benchmark Analysis: Feature Comparison
...
### 3.2 Strategic Action Plan- Top 3 Growth Tactics
